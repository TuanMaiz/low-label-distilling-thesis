...
Start with Phase 1 of the active plan. Freeze the exact datasets, models,
teacher, prompt, evaluation scope, artifact schema, and cost ceiling before
implementing new loaders or making paid teacher calls.
...
datasets, targets, and students are verified.
