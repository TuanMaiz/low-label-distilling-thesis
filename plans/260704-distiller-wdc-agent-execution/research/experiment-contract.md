...
Post-pilot revision declared on 2026-07-16 and amended on 2026-07-17, before
the second-student run or any test evaluation:

- Preserve the completed FLAN-T5-base results as the first-student evidence.
- Add public, ungated `answerdotai/ModernBERT-base` with a binary
  sequence-classification head as the second-student architecture diagnostic.
  It replaces the unrun Gemma 3 270M choice solely to avoid gated-model access;
  no experiment results informed the substitution.
